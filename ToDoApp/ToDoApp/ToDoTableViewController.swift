...
class ToDoTableViewController: UITableViewController,addingTaskDetail {
  
    
    
    /*ar allTasks=taskManager.shared.tasks*/
//    var allTasks: [Task] {
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = allTasks[indexPath.row].isUrgent ? UIColor.red : UIColor.green
...
//        allTasks.append(newTask)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let addingVC=segue.destination as? secondViewController
